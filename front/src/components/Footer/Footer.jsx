        ...
        <footer className={styles.footer} id="footer">
            <div className='container'>
                ...
                <section>
                    ...
                    <ul className={styles.footerList}>
                        <li>
                            <Link to="tel:+375(17)6543210" className={styles.contactLink}><img src={Phone} alt="phone"/>+375(17)6543210</Link>
                        </li>
                        <li>
                            <Link to="mailto:test@mail.ru" className={styles.contactLink}><img src={Mail} alt="email"/>test@mail.ru</Link>
                        </li>
